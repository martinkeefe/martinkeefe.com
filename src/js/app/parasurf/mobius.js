import {calcParametricGeometry,calcParametricWireGeometry} from '../parasurf-calc'
    ...
    return [
        {
            calc: function(u_dom, v_dom, p, t) {
                ...
                return calcParametricGeometry(func, u_dom, v_dom, t);
            },
            domain: [
        ...
        },
        {
            ...
            calc: function(u_dom, v_dom, p, t) {
                ...
                return {wire: calcParametricWireGeometry(func, u_dom, v_dom, t)};
            },
            is_surface: false,
            show: true
        },
        {
            ...
            calc: function(u_dom, v_dom, p, t) {
                ...
                var wire1 = calcParametricWireGeometry(func1, u_dom, v_dom, t);
                ...
                var wire2 = calcParametricWireGeometry(func2, u_dom, v_dom, t);
                return [wire1,wire2];
            },
            is_surface: false,
            show: true
